...
links <- data.frame(
  ...
  target=c("", "", "", "",  "Terrestrial","Freshwater (Anadromous)", "Nearshore", "Marine", "Berries", "Birds/Eggs", "Large Land Mammals", "Plants/Greens/Mushrooms", "Small Land Mammals", "Char","Other Freshwater/Anadromous Fish", "Salmon",  "Trout", "Herring Roe", "Molluscs", "Crabs", "Other", "Seaweed/Kelp", "Halibut", "Non-Halibut Fish", "Marine Invertebrates", "Marine Mammals" ), 
  value=c(23.954, 34.385, 9.764, 31.897, 23.954, 34.385, 9.764, 31.897,  4.707, 0.640, 17.942, 0.575, 0.092, 1.367,0.737, 31.596,  0.688, 2.833, 3.015, 2.550, 0.361, 1.006, 15.643, 7.639, 6.517, 2.094)
)
...
##calculate cost -- assuming $20/pound of food 
total_harvest_all_lb <- total_harvest_all_kg*2.2
total_cost <- total_harvest_all_kg*20


total_cost_per_person <- total_cost/total_pop
