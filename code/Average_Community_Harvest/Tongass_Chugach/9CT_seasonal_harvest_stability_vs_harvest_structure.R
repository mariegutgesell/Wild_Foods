...
simulated_harvest_df <- read.csv("data/intermediate_data/simulated_harvest_distributions_harvest_proportion.csv")
...
comm_div <- read.csv("data/intermediate_data/harvest_diversity_metrics.csv") %>%
  rename(site = "Site")
