...
##Exploring temporal trends in harvest magnitude over time
ggplot(df_temp_avg_total, aes(x = Year, y = Percapita_Pounds_Harvested_sum_total)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Community)

ggplot(df_temp_avg_total, aes(x = Year, y = Estimated_Total_Pounds_Harvested_sum_total)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Community)
