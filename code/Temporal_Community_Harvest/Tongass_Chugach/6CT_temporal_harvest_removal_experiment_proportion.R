...
harvest_div <- read.csv("data/intermediate_data/temporal_survey_harvest_diversity_metrics_proportion.csv")
...
write.csv(comm_div_2, "data/intermediate_data/temporal_harvest_removal_results_proportion.csv")
