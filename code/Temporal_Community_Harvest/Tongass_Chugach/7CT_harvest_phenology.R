...
simulated_harvest_prop <- lapply(1:nrow(df_hp_a_2), function(i) {
  ...
  Site <- df_hp_a_2$Site_Year_Code[i]
...
write.csv(simulated_harvest_prop_df, "data/intermediate_data/temporal_survey_simulated_harvest_distributions_harvest_proportion.csv")
