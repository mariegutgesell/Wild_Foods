##Looking at temporal changes in relationships between harvest structure and stability
...
ggplot(df_hc, aes(x = Year, y = richness)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)
...
ggplot(df_hc, aes(x = Year, y = sw_diversity)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)

ggplot(df_hc, aes(x = Year, y = evenness)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)

ggplot(df_hc, aes(x = Year, y = sd)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)

ggplot(df_hc, aes(x = Year, y = alpha)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)

ggplot(df_hc, aes(x = Year, y = harvest_total_cv)) +
  geom_point() +
  geom_line() +
  theme_classic() +
  facet_wrap(~Site)
...
ggplot(mean_hc_cv, aes(x = evenness_mean, y = cv_ph)) +
  geom_point() +
  geom_smooth(method = "lm") +
  theme_classic() +
...
ggplot(df_hc) +
  ...
  geom_line(data = df_hc, aes(x = Year, y= scale(log_1_SD), group = Site, color = "red")) +
  facet_wrap(~Site)
...
ggplot(df_hc, aes(x = sw_diversity, y = sd)) +
  geom_point() +
  geom_smooth(method = "lm")
