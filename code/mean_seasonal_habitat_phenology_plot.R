...
##Create plot 
seasonal_plot_mean <- ggplot() +
  geom_line(data = total_simulated_harvest, aes(x = date, y = harvest_mean, group = habitat, color = habitat), linewidth = 1) +
  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_area(data = total_simulated_harvest, aes(x = date, y = harvest_mean, fill = habitat), position = "identity", alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Calendar Year", y = "Daily Harvest Amount\n(kg/person)") +
  theme_classic()+
  # ylim(0,3.0) +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 16),axis.title.y=element_text(size = 18), axis.title.x = element_text(size = 18), legend.position = "right", legend.title = element_text("Habitat"), text = element_text(family = "Avenir"), legend.text = element_text(size = 16)) #+
#theme(plot.margin = unit(c(0.25, 1, 0.25, 0.25), "cm"))
seasonal_plot_mean

seasonal_plot_sum <- ggplot() +
  geom_line(data = total_simulated_harvest, aes(x = date, y = harvest_sum, group = habitat, color = habitat), linewidth = 1) +
  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_area(data = total_simulated_harvest, aes(x = date, y = harvest_sum, fill = habitat), position = "identity", alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Calendar Year", y = "Daily Harvest Amount\n(kg/person)") +
  theme_classic()+
  # ylim(0,3.0) +
...
seasonal_plot_sum_2<- ggplot() +
  #  geom_point(data = total_simulated_harvest_2, aes(x = date, y = harvest_mean, group = habitat, color = habitat)) +
  #  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_smooth(data = total_simulated_harvest, aes(x = date, y = harvest_sum, group = habitat, fill = habitat, color = habitat), alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
...
seasonal_plot_mean_2 <- ggplot() +
 # geom_point(data = simulated_harvest_df, aes(x = date, y = harvest_amount_kg, group = habitat, color = habitat)) +
#  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_smooth(data = simulated_harvest_df, aes(x = date, y = harvest_amount_kg, group = habitat, fill = habitat, color = habitat), alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  scale_color_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Calendar Year", y = "Daily Harvest Amount\n(kg/person)") +
  theme_classic()+
...
ia_plot_sum <- ggplot() +
  geom_line(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_sum, group = habitat, color = habitat), linewidth = 1) +
  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_area(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_sum, fill = habitat), position = "identity", alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Year", y = "Annual Harvest Amount\n(kg/person)") +
  theme_classic()+
  # ylim(0,3.0) +
  theme(axis.text.x = element_text(size = 16, angle = 45, hjust = 1),  axis.text.y = element_text(size = 16),axis.title.y=element_text(size = 18), axis.title.x = element_text(size = 18), legend.position = "right", legend.title = element_text("Habitat"), text = element_text(family = "Avenir"), legend.text = element_text(size = 16)) #+
#theme(plot.margin = unit(c(0.25, 1, 0.25, 0.25), "cm"))
ia_plot_sum

ia_plot_sum_2 <- ggplot() +
  # geom_point(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_mean, group = habitat, color = habitat), alpha = 0.7) +
  #   scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_smooth(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_sum, group = habitat, fill = habitat, color = habitat), alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  scale_color_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Year", y = "Daily Harvest Amount\n(kg/person)") +
  theme_classic() +
  # ylim(0,3.0) +
  theme(axis.text.x = element_text(size = 16, angle = 45, hjust = 1),  axis.text.y = element_text(size = 16),axis.title.y=element_text(size = 18), axis.title.x = element_text(size = 18), legend.position = "right", legend.title = element_text("Habitat"), text = element_text(family = "Avenir"), legend.text = element_text(size = 16)) #+
#theme(plot.margin = unit(c(0.25, 1, 0.25, 0.25), "cm"))
...
ia_plot_mean <- ggplot() +
  geom_line(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_mean, group = habitat, color = habitat), linewidth = 1) +
  scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_area(data = ia_total_simulated_harvest, aes(x = Year, y = harvest_mean, fill = habitat), position = "identity", alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Year", y = "Annual Harvest Amount\n(kg/person)") +
  theme_classic()+
  # ylim(0,3.0) +
...
ia_plot_mean_2 <- ggplot() +
   geom_point(data = ia_simulated_harvest_df, aes(x = Year, y = harvest_amount_kg, group = habitat, color = habitat), alpha = 0.7) +
#   scale_colour_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  geom_smooth(data = ia_simulated_harvest_df, aes(x = Year, y = harvest_amount_kg, group = habitat, fill = habitat, color = habitat), alpha = 0.5) + 
  scale_fill_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  scale_color_manual(values = c("#FF9999","#003366","#CC9966", "#339933"))+
  labs(x = "Year", y = "Daily Harvest Amount\n(kg/person)") +
  theme_classic() +
...
str(ia_total_simulated_harvest)
