...
total_harvest_rank <- df_2 %>%
  dplyr::select(Site_Year_Code:Trophic_Category, Estimated_Total_Pounds_Harvested_sum, Total_Harvest_prop) %>%
  group_by(Site_Year_Code) %>%
...
th_rank_10_a <- total_harvest_rank %>%
 ...
 dplyr:: select(Site_Year_Code, Lowest_Common_Taxon_Name, Habitat, Trophic_Level, Trophic_Category, Estimated_Total_Pounds_Harvested_sum, Total_Harvest_prop, harvest_rank)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_10_std_max, iter.max = 1000, centers = 2)
...
##NMDS
sp_NMDS_1 <- metaMDS(th_rank_10_std_max,  autotransform = FALSE, distance = "manhattan", na.rm = TRUE) 
stressplot(sp_NMDS_1)
##a rule of thumb is that stress should be less than 0.2, ideally less than 0.1 
sp_NMDS_1$stress
plot(sp_NMDS_1)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_10_std_range, iter.max = 1000, centers = 2)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_10_std_rank, iter.max = 1000, centers = 4)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_10_std_sq, iter.max = 1000, centers = 9)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_5_std_max, iter.max = 1000, centers = 10)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_5_std_range, iter.max = 1000, centers = 10)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_5_std, iter.max = 1000, centers = 3)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_5_std_sq, iter.max = 1000, centers = 9)
...
##K-means clustering  -- common clustering approach that uses algorithm that minimizes intracluster distances, based on sum of squares of euclidean distances to centroid
k2 <- kmeans(th_rank_5_std_log, iter.max = 1000, centers = 7)
