...
supp_fig <-  ggarrange(avg_robust_richness, avg_robust_evenness, avg_cv_richness, avg_cv_evenness, decadal_cv_richness, decadal_cv_evenness, nrow = 3, ncol = 2, labels = c("i)", "ii)", "i)", "ii)", "i)", "ii)"), font.label = list(colour = "black", size = 14, family = "Avenir"))
supp_fig
